...
<?php
        $ID = $_SESSION["ID"];
        try {
            $sql = "SELECT ID, nome, cognome FROM faraza.utente";
...
?>
		        ...
		        <form action='profiloutente.php' method='GET'>
			        <label for="num">Scegli utente da visualizzare</label>
		            <select class='form-control' name='num' id='num'>
<?php
            $sql = "SELECT * FROM faraza.utente";
