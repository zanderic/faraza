...
?>
		            ...
		            <form action='recensione.php' method='POST'>
			            <label for="num">Scegli il centro</label>
...
?>
		                ...
		                <label for="recensione">Commento</label>
		                <textarea class='form-control' name="recensione" id="recensione" rows="3" required></textarea><br>
