...
<html>
<head>
    <title>Faraza - Informazioni</title>
	<meta charset="UTF-8">
		...
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-success">
				<div class="panel-heading">
					<h3 align="center" class="panel-title">Informazioni</h3>
				</div>
				<div class="panel-body">
					<form action="aggiornainformazioniutente.php" method="POST"> 
		                ...
		                <tr>
		                    <th>Password</th>
		                    <td> <input class='form-control' type='text' name='Pass'  value="<?php echo $_SESSION["pass"]?>" ></td>                    
		                </tr>
		                <tr>
		                    <th>Telefono</th>
		                    <td> <input class='form-control' type='text' name='Tell'  value="<?php echo $_SESSION["telefono"]?>" ></td>
		                </tr>
						</tbody>
						</table>
		            <button type='submit' class='btn btn-block btn-success'>Aggiorna informazioni</button>
					</form>
				</div>
			</div>
		</div>
